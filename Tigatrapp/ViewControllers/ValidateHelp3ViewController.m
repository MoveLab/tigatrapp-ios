...
#import "ValidateHelp3ViewController.h"
#import "RestApi.h"
#import "LocalText.h"

@interface ValidateHelp3ViewController ()

@end

@implementation ValidateHelp3ViewController
...
- (void)viewDidLoad {
    ...
    _subtitleLabel.text = [LocalText with:@"i18n_thorax2"];
